...
export default function AdminDashboard() {
  ...
  async function handleApprove(
    ...
    try {
      ...
      /*
       * Frontend tidak update SENT langsung.
       *
       * Admin
       *   ↓
  ...
  return (
    <div className="min-h-screen bg-[#070B12] text-white">
      ...
      <main className="relative mx-auto max-w-[1600px] px-5 py-8 lg:px-8 lg:py-10">
        {/* =========================================================
            HEADING
        ========================================================= */}
        ...
        <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-white/70">
              Review AI-qualified opportunities and approve outreach before any
        ...
        <div className="mt-8 flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/[0.03] p-3 sm:flex-row sm:items-center">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Search name, email, company or AI reason..."
                          ...
                          <td className="px-5 py-5">
                            <div className="max-w-[340px]">
                              <div className="mb-1.5 flex items-center gap-1.5">
                                <BrainCircuit className="h-3.5 w-3.5 shrink-0 text-indigo-400" />
                              ...
                              <p
                                ...
                                className="line-clamp-3 text-xs leading-5 text-white/70"
                              >
                                {lead.ai_qualification_reason ||
                                  "No AI qualification reason available."}
                              </p>
                            </div>
                          </td>
      ...
      <aside className="fixed bottom-0 right-0 top-0 z-50 w-full max-w-xl overflow-y-auto border-l border-white/10 bg-[#0A0F18] shadow-2xl shadow-black/60">
        ...
        <div className="space-y-6 p-6">
          ...
          <DrawerSection
            ...
            icon={BrainCircuit}
          >
            <div className="rounded-xl border border-indigo-400/15 bg-indigo-500/[0.05] p-4">
